...
namespace StarResult
{
    ...
    public static class Global
    {
        ...
        public static bool gShowLogo { get; set; } = false;
        static Global()
        {
        ...
        public static void loadConfig()
        {
            ...
            var node = doc.SelectSingleNode("/starResult");
            if (node != null)
            {
            ...
            node = doc.SelectSingleNode("/starResult/data");
    ...
    {
        const string Program = "Result Viewer";
        const string Date = "2024/06/04";
