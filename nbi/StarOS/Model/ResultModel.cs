...
namespace StarOS.Model
{
    ...
    {
        public Dictionary<string, bool> _conDic = new Dictionary<string, bool>();
        public Dictionary<string, bool> _curDic = new Dictionary<string, bool>();
        public Dictionary<string, bool> _totalDic = new Dictionary<string, bool>();

        public Dictionary<string, bool> _maskDic = new Dictionary<string, bool>();
    ...
    public class StepModel : BaseVM
    {
        ...
        public int _passCnt = 0;  // current
        public int _testCnt = 0;  // mount 
        public int _totalCnt = 0; // 최종 pass
        public int _maskCnt = 0;
        ...
        static public SUB_TYPE findSubType(string type)
        {
            ...
            else if (type == "meas-data")
                subType = SUB_TYPE.MEAS_DATA;
            return subType;
        }
