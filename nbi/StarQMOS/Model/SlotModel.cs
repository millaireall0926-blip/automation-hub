    ...
    public class SlotModel : BaseVM
    {
        ...
        public string BID
        {
            ...
            set
            {
                ...
                {
                    sbid = "";
                    _numBid = Convert.ToInt32(value, 16);

                    int nSerial = _numBid & 0xffff;
                    int nBall = (_numBid >> 16) & 0xf;
                    int nDevFam = (_numBid >> 20) & 0x1f;
                    int nFunc = (_numBid >> 25) & 0x7;
...
//            Global.gMainVM.updateUIFlag((int)UI.SLOTLOG);
        ...
        public bool HanlderDone { get; set; } = false;
