...
enum {	
	...
	VH9,	VH10,	VH11,	VH12,	VH13,	VH14,	VH15,	VH16,	
	VTH1,	VTH2,	VTH3,	VTH4,	VTH5,	VTH6,	VTH7,	VTH8,	
	HV1,	HV2,	HV3,	HV4,	
	VREF1,	VREF2,	VREF3,	VREF4,
	MAX_PWR_ADC_CH,
	VH_ALL, VTH_ALL, HV_ALL, VREF_ALL, DPS_ALL
};
...
//////////////////////////////////////////
enum {
	// DR Pins (A-side and B-side) - 0 based
	DR0, DR0_B, DR1, DR1_B, DR2, DR2_B, DR3, DR3_B, DR4, DR4_B, 
	DR5, DR5_B, DR6, DR6_B, DR7, DR7_B, DR8, DR8_B, DR9, DR9_B, 
	DR10, DR10_B, DR11, DR11_B, DR12, DR12_B, DR13, DR13_B, DR14, DR14_B, DR15, DR15_B,
	DR16, DR16_B, DR17, DR17_B, DR18, DR18_B, DR19, DR19_B, DR20, DR20_B, 
	DR21, DR21_B, DR22, DR22_B, DR23, DR23_B, DR24, DR24_B, DR25, DR25_B,
	DR26, DR26_B, DR27, DR27_B, DR28, DR28_B, DR29, DR29_B, DR30, DR30_B,
	DR31, DR31_B, DR32, DR32_B, DR33, DR33_B, DR34, DR34_B, DR35, DR35_B,
	DR36, DR36_B, DR37, DR37_B, DR38, DR38_B, DR39, DR39_B, DR40, DR40_B,
	DR41, DR41_B, DR42, DR42_B, DR43, DR43_B, DR44, DR44_B,

	// IO Pins (A-side and B-side) - 0 based
	IO0, IO0_B, IO1, IO1_B, IO2, IO2_B, IO3, IO3_B, IO4, IO4_B, IO5, IO5_B, IO6, IO6_B,
	IO7, IO7_B, IO8, IO8_B, IO9, IO9_B, IO10, IO10_B, IO11, IO11_B, IO12, IO12_B, IO13, IO13_B, IO14, IO14_B, IO15, IO15_B,
	...
	IO32, IO32_B, IO33, IO33_B, IO34, IO34_B, IO35, IO35_B,
...
/*
Brieping
	int type : DAC Channel Select
		VH1~VH16
		VTH1~VTH8
		VREF1~VREF4
		HV1~HV4
	double volt : Voltage Setting
Setting DAC Channel Voltage
*/
...
float GET_DPS_V(int ch, int cnt = 1, bool bCalApply = true);//
/*
Brieping
	int type : Channel Select
		VS0~VS19
...
*/
float GET_DPS_A(int ch, int cnt = 1, bool bCalApply = true);//


void TIME(int seq, float delay, std::initializer_list<uint64> values );
/*
Brieping
	int seq : Sequnce Select
	int delay : Delay Time Sec Unit
		Availabel US MS S MIN HOUR
	int Select : VS Group, HV Group, VREF Group
				 DPS_ALL, HV_ALL, VREF_ALL, VH_ALL, VTH_ALL
					VS1~VS16, HV1~HV4,VREF1~4  -> {VS1,VS2,VS10}
  ex) TIME(0, 10 MS, {VS1, VS2, VS10} );
	  TIME(1, 10 MS, {HV1, HV2} );  	
...
void SHOW_FMDATA(int offset, int readSZ, int Mode = SHOW_BOTH);
