...
//                .WriteTo.Console()
        ...
        public static bool    gOsMode = false;
        ...
        public static void loadConfig()
        {
			...
			node = doc.SelectSingleNode("/staros/setup");
			if (node != null && int.TryParse(node.Attributes["mode"].Value, out int modeVal))
				gOsMode = (modeVal == 1);
			else
				gOsMode = false;
    ...
    public static class VerInfo {
        ...
        const string Ver = "V1.1.7.H - Result Modify";
	...
	/*
	    const string Date = "2026/02/24";
        const string Ver = "V1.1.7.H - Result Modify";
            V1.1.5H 로 RollBack & Resut Bin Color 수정
     
        const string Program = "Star OS";
        const string Date = "2026/02/13";
        const string Ver = "V1.1.6.H (All Slots & Single Mode)";
     
     const string Date = "2025/09/29";
     const string Ver = "V1.1.5.H (Rotate BIB)";
         BIB 세로로
         main 투명 부분 제거.
    ...
    const string Program = "Star OS";
        ...
        const string Ver = "V1.1.4.H (OS Header Manage)";
