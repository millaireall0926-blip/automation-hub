...
namespace StarOS.ViewModel
{
    public class ChamberVM : BaseVM
    {
        ...
        public int _intervalWatchDog = 10;
            ...
            while (vm._plcThreadClose == false) {
                foreach (PLCModel plc in vm._plcs) {
                    ...
                    if (plc.isConnect()) {
                        ...
                        //if (!prevConnect) { 
                        //
                        //    if (Global.gEnableWatchDog)
                        //    {
                        //        bool ret = plc._modbus.setWatchDogTimeoutFunc(Global.gWatchDocTimeout);
                        //        Global.gTestVM.addSysLog(LOG_TYPE.INFO, "plc", $"WatchDoc Timeout {Global.gWatchDocTimeout}s. Resp = {ret.ToString()}");
                        //        ret = plc._modbus.enableWatchDocFunc(true);
                        //        Global.gTestVM.addSysLog(LOG_TYPE.INFO, "plc", $"Enable WatchDoc. Resp = {ret.ToString()}");
                        //        
                        //    }else
                        //    {
                        //        plc._modbus.enableWatchDocFunc(false);
                        //    }
                        //    prevConnect = true;
                        //}
                        ...
                        //if (Global.gEnableWatchDog)
                        //{
                        //    if (vm._intervalWatchDog > 10)
                        //    {
                        //        vm._intervalWatchDog = 0;
                        //        bool ret = plc._modbus.toggleWatchDogFunc();
                        //        Global.gTestVM.addSysLog(LOG_TYPE.INFO, "plc", $"WatchDoc Toggle. Resp = {ret.ToString()}");
                        //    }
                        //
                        //    vm._intervalWatchDog++;
                        //}
