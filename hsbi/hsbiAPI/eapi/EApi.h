 ...
 *   none.
 */
#define EAPI_STATUS_DRIVER_ERROR      EAPI_UINT32_C(0xFFFFF8FF)
...
#define EAPI_STATUS_ERROR             EAPI_UINT32_C(0xFFFFF0FF)
 ...
 /* Description
 *   Mutex/Semaphore protection in EAPI for multi-process calling EAPI at the same time.
     Hardware resource occupied by another user (thread/process)
 * Actions
 *   none.
 */
#define EAPI_STATUS_SW_TIMEOUT        EAPI_UINT32_C(0xFFFFF012)
...
// DFI define
#define EAPI_ID_BOARD_JSON_STR             EAPI_UINT32_C(0x1000)
#define EAPI_ID_BOARD_PN_STR               EAPI_UINT32_C(0x1001)
#define EAPI_ID_HWMON_VOLTAGE_SUPPORT_LIST EAPI_UINT32_C(0x1002)
#define EAPI_ID_BOARD_PN_STR_EX            EAPI_UINT32_C(0x1003)
#define EAPI_ID_BOARD_MODEL_NAME           EAPI_UINT32_C(0x1004)
#define EAPI_ID_BOARD_SYSTEM_NAME          EAPI_UINT32_C(0x1005)
 ...
 * Hardware resource occupied by another
 * user (thread/process)                  | EAPI_STATUS_SW_TIMEOUT
 * Common Error                           | Common Error Code
 * Else                                   | EAPI_STATUS_SUCCESS
 */
EApiStatus_t
...
EApiBoardGetStringExA(
    __IN    EApiId_t  Id, /* Name Id */
    __IN        char *pplatform_code,/* platform appllo, kabylake or etc.*/
    __IN        char *pmemory_type,/* memory type. DDR3, DDR4 or etc.*/
    __OUT       char *pBuffer,/* Destination pBuffer */
    __INOUT uint32_t *pBufLen/* pBuffer Length */
);
/*
...
#define EAPI_ID_BOARD_LIB_VERSION_VAL     EAPI_UINT32_C(0x10001) /* Vendor Specific
                                                                  * (Optional) 
                                                                  */
// All temperature are 0.1 Kelvins
...
// DFI define
#define EAPI_ID_HWMON_SYSTEM2_TEMP        EAPI_UINT32_C(0x20003)
#define EAPI_ID_HWMON_SYSTEM3_TEMP        EAPI_UINT32_C(0x20004)
#define EAPI_ID_HWMON_SYSTEM4_TEMP        EAPI_UINT32_C(0x20005)
#define EAPI_ID_HWMON_SYSTEM5_TEMP        EAPI_UINT32_C(0x20006)
#define EAPI_ID_HWMON_SYSTEM6_TEMP        EAPI_UINT32_C(0x20007)
#define EAPI_ID_HWMON_SYSTEM7_TEMP        EAPI_UINT32_C(0x20008)
#define EAPI_ID_HWMON_CPU2_TEMP           EAPI_UINT32_C(0x20009)
...
// DFI define
#define EAPI_ID_HWMON_VOLTAGE_3VSB        EAPI_UINT32_C(0x21020)
#define EAPI_ID_HWMON_VOLTAGE_VDDQ        EAPI_UINT32_C(0x21024)    // DDR, DDR3, DDR3L, DDR4 ... etc
#define EAPI_ID_HWMON_VOLTAGE_VCORE2      EAPI_UINT32_C(0x21028)
#define EAPI_ID_HWMON_VOLTAGE_QPI_VTT     EAPI_UINT32_C(0x2102C)
#define EAPI_ID_HWMON_VOLTAGE_QPI_VTT2    EAPI_UINT32_C(0x21030)
#define EAPI_ID_HWMON_VOLTAGE_VGFX        EAPI_UINT32_C(0x21034)
#define EAPI_ID_HWMON_VOLTAGE_AVSB        EAPI_UINT32_C(0x21038)
#define EAPI_ID_HWMON_VOLTAGE_1V05        EAPI_UINT32_C(0x2103C)    // some 1.05 or 1V on EC chip
#define EAPI_ID_HWMON_VOLTAGE_VCCSA       EAPI_UINT32_C(0x21040)    // System Agent 

#define EAPI_ID_HWMON_VOLTAGE_1V2_DDR4    EAPI_UINT32_C(0x21044)    // System Agent 
#define EAPI_ID_HWMON_VOLTAGE_VCCGT       EAPI_UINT32_C(0x21048)    // System Agent 
#define EAPI_ID_HWMON_VOLTAGE_VCCIO       EAPI_UINT32_C(0x2104C)    // System Agent 
#define EAPI_ID_HWMON_VOLTAGE_VNN         EAPI_UINT32_C(0x21050)    // System Agent 
#define EAPI_ID_HWMON_VOLTAGE_1V0         EAPI_UINT32_C(0x21054)    // System Agent 
#define EAPI_ID_HWMON_VOLTAGE_VDDNB       EAPI_UINT32_C(0x21058)    // System Agent 
#define EAPI_ID_HWMON_VOLTAGE_1V8         EAPI_UINT32_C(0x2105C)    // System Agent 
#define EAPI_ID_HWMON_VOLTAGE_0V95        EAPI_UINT32_C(0x21060)    // System Agent 
#define EAPI_ID_HWMON_VOLTAGE_1V15        EAPI_UINT32_C(0x21064)    // System Agent

#define EAPI_ID_HWMON_VOLTAGE_EC_V0       EAPI_UINT32_C(0x21100)
#define EAPI_ID_HWMON_VOLTAGE_EC_V1       EAPI_UINT32_C(0x21101)
#define EAPI_ID_HWMON_VOLTAGE_EC_V2       EAPI_UINT32_C(0x21102)
#define EAPI_ID_HWMON_VOLTAGE_EC_V3       EAPI_UINT32_C(0x21103)
#define EAPI_ID_HWMON_VOLTAGE_EC_V4       EAPI_UINT32_C(0x21104)

// All FAN speed are RPM
#define EAPI_ID_HWMON_FAN_CPU             EAPI_UINT32_C(0x22000)
#define EAPI_ID_HWMON_FAN_SYSTEM          EAPI_UINT32_C(0x22001)

// DFI define
#define EAPI_ID_HWMON_FAN_SYSTEM2         EAPI_UINT32_C(0x22002)
#define EAPI_ID_HWMON_FAN_SYSTEM3         EAPI_UINT32_C(0x22003)
#define EAPI_ID_HWMON_FAN_SYSTEM4         EAPI_UINT32_C(0x22004)
#define EAPI_ID_HWMON_FAN_SYSTEM5         EAPI_UINT32_C(0x22005)
#define EAPI_ID_HWMON_FAN_SYSTEM6         EAPI_UINT32_C(0x22006)
#define EAPI_ID_HWMON_FAN_SYSTEM7         EAPI_UINT32_C(0x22007)
#define EAPI_ID_HWMON_FAN_CPU2            EAPI_UINT32_C(0x22008)

// DFI define
#define EAPI_ID_EC_VERSION                EAPI_UINT32_C(0x30000)    // hight byte : main version
 ...
 * Hardware resource occupied by another user
 * (thread/process)                             | EAPI_STATUS_SW_TIMEOUT
 * Common Error                                 | Common Error Code
 * Else                                         | EAPI_STATUS_SUCCESS
 */
EApiStatus_t 
...
#define EAPI_ID_I2C_EXTERNAL_2     EAPI_UINT32_C(3) /* External I2C Interface 2 */
#define EAPI_ID_I2C_EXTERNAL_3     EAPI_UINT32_C(4) /* External I2C Interface 3 */
#define EAPI_ID_I2C_EXTERNAL_4     EAPI_UINT32_C(5) /* External I2C Interface 4 */
...
#define EAPI_I2C_ENC_STD_CMD(x)  EAPI_UINT32_C(((x)&0x00FF)|EAPI_I2C_STD_CMD)
#define EAPI_I2C_ENC_EXT_CMD(x)  EAPI_UINT32_C(((x)&0xFFFF)|EAPI_I2C_EXT_CMD)
#define EAPI_I2C_ENC_NO_CMD(x)   EAPI_UINT32_C(((x)&0x0000)|EAPI_I2C_NO_CMD)
...
EApiWDogGetCap(
    ...
    __OUTOPT uint32_t *pMaxEventTimeout, /* Maximum Supported Event Timeout in milliseconds, 0 == Unsupported */
    __OUTOPT uint32_t *pMaxResetTimeout  /* Maximum Supported Reset Timeout in milliseconds */
    );
/* 
 * EApiWDogStart
 * 
 ...
 * Hardware resource occupied by
 * another user (thread/process)    | EAPI_STATUS_SW_TIMEOUT
 * Common Error                     | Common Error Code
 * Else                             | EAPI_STATUS_SUCCESS
 */
EApiStatus_t 
...
#define EAPI_ID_GPIO_GPIO00     EAPI_GPIO_GPIO_ID(0)
#define EAPI_ID_GPIO_GPIO01     EAPI_GPIO_GPIO_ID(1)
#define EAPI_ID_GPIO_GPIO02     EAPI_GPIO_GPIO_ID(2)
#define EAPI_ID_GPIO_GPIO03     EAPI_GPIO_GPIO_ID(3)
#define EAPI_ID_GPIO_GPIO04     EAPI_GPIO_GPIO_ID(4)
#define EAPI_ID_GPIO_GPIO05     EAPI_GPIO_GPIO_ID(5)
#define EAPI_ID_GPIO_GPIO06     EAPI_GPIO_GPIO_ID(6)
#define EAPI_ID_GPIO_GPIO07     EAPI_GPIO_GPIO_ID(7)
...
EApiStatus_t 
EAPI_CALLTYPE 
EApiGPIOGetCount(__OUT uint32_t *pCount);
 ...
 *
 */
#define EAPI_ID_CASHDRAW_1              EAPI_UINT32_C(0)

 /* Status */
#define EAPI_CASHDRAW_CLOSE   0
#define EAPI_CASHDRAW_OPEN    1

EApiStatus_t 
EAPI_CALLTYPE 
EApiCashDrawSetDrawerOpen(__IN EApiId_t Id);

EApiStatus_t 
EAPI_CALLTYPE 
EApiCashDrawChangePushVoltage(__IN EApiId_t Id);

EApiStatus_t 
EAPI_CALLTYPE 
EApiCashDrawGetPushVoltage(__IN EApiId_t Id, __OUT uint32_t *pLevel);

EApiStatus_t 
EAPI_CALLTYPE 
EApiCashDrawGetDrawerStatus(__IN EApiId_t Id, __OUT uint32_t *pLevel);
 ...
 *
 */
#define EAPI_ID_CASEOPEN_1              EAPI_UINT32_C(0)

EApiStatus_t 
EAPI_CALLTYPE 
EApiCaseOpenGetCaseStatus(__IN EApiId_t Id, __OUT uint32_t *pValue);

EApiStatus_t 
EAPI_CALLTYPE 
EApiCaseOpenGetCaseBeepStatus(__IN EApiId_t Id, __OUT uint32_t *pValue);

EApiStatus_t 
EAPI_CALLTYPE 
EApiCaseOpenEnableCaseBeep(__IN EApiId_t Id, __IN uint32_t value);

EApiStatus_t 
EAPI_CALLTYPE 
EApiCaseOpenResetCaseStatus(__IN EApiId_t Id);
 ...
 *
 */
#define EAPI_ID_FAN_CPU                 EAPI_UINT32_C(0)
#define EAPI_ID_FAN_SYSTEM              EAPI_UINT32_C(1)
#define EAPI_ID_FAN_SYSTEM2             EAPI_UINT32_C(2)

EApiStatus_t 
EAPI_CALLTYPE 
EApiSmartFanGetBoundaryTempSets(
    __IN  EApiId_t  Id         , /* FAN Id */
    __OUT uint32_t *pTemp1     ,
    __OUT uint32_t *pTemp2     ,
    __OUT uint32_t *pTemp3     ,
    __OUT uint32_t *pTemp4
    );

EApiStatus_t 
EAPI_CALLTYPE 
EApiSmartFanSetBoundaryTempSets(
    __IN  EApiId_t  Id         , /* FAN Id */
    __IN  uint32_t  Temp1      ,
    __IN  uint32_t  Temp2      ,
    __IN  uint32_t  Temp3      ,
...
EApiStatus_t 
EAPI_CALLTYPE 
EApiSmartFanGetFanSpeedSets(
    __IN  EApiId_t  Id         , /* FAN Id */
    __OUT uint32_t *pLevel1    ,
    __OUT uint32_t *pLevel2    ,
    __OUT uint32_t *pLevel3    ,
    __OUT uint32_t *pLevel4
    );

EApiStatus_t 
EAPI_CALLTYPE 
EApiSmartFanSetFanSpeedSets(
    __IN  EApiId_t  Id         , /* FAN Id */
    __IN  uint32_t  Level1     ,
    __IN  uint32_t  Level2     ,
    __IN  uint32_t  Level3     ,
    __IN  uint32_t  Level4
    );
 ...
 *
 */
#define EAPI_ID_ASTFAN_A                EAPI_UINT32_C(0)
#define EAPI_ID_ASTFAN_B                EAPI_UINT32_C(1)
#define EAPI_ID_ASTFAN_C                EAPI_UINT32_C(2)
#define EAPI_ID_ASTFAN_D                EAPI_UINT32_C(3)
#define EAPI_ID_ASTFAN_E                EAPI_UINT32_C(4)
#define EAPI_ID_ASTFAN_F                EAPI_UINT32_C(5)
#define EAPI_ID_ASTFAN_G                EAPI_UINT32_C(6)
#define EAPI_ID_ASTFAN_H                EAPI_UINT32_C(7)

#define EAPI_ASTFAN_SET_ON              EAPI_UINT32_C(1)
#define EAPI_ASTFAN_SET_OFF             EAPI_UINT32_C(0)
...
EApiASTFanGetPWM(
    __IN  EApiId_t  Id,
    __IN  uint32_t  index,
    __OUT uint8_t  *pUpgradeTemperature,
    __OUT uint8_t  *pUpgradePWMDutyCycle,
    __OUT uint8_t  *pDowngradeTemperature,
    __OUT uint8_t  *pDowngradePWMDutyCycle
    );
...
EApiASTFanSetPWM(
    __IN  EApiId_t Id,
    __IN  uint32_t index,
    __IN  uint8_t  UpgradeTemperature,
    __IN  uint8_t  UpgradePWMDutyCycle,
    __IN  uint8_t  DowngradeTemperature,
    __IN  uint8_t  DowngradePWMDutyCycle
    );

EApiStatus_t
EAPI_CALLTYPE
EApiGetEAPIVersion(
    __OUT  uint8_t   *MajorNumber,
    __OUT  uint8_t   *MinorNumber,
    __OUT  uint8_t   *ReleaseNumber,
    __OUT  uint16_t  *BuildNumber
);
...
*
*/
#define JTAG_TEST_LOGIC_RESET	EAPI_UINT32_C(0)
#define JTAG_RUN_TEST_IDLE		EAPI_UINT32_C(1)
#define JTAG_SELECT_DR_SCAN		EAPI_UINT32_C(2)
#define JTAG_SELECT_IR_SCAN		EAPI_UINT32_C(3)
#define JTAG_SHIFT_DR			EAPI_UINT32_C(4)
#define JTAG_SHIFT_IR			EAPI_UINT32_C(5)
#define JTAG_EXIT1_DR			EAPI_UINT32_C(6)
#define JTAG_EXIT1_IR			EAPI_UINT32_C(7)
#define JTAG_EXIT2_DR			EAPI_UINT32_C(8)
#define JTAG_EXIT2_IR			EAPI_UINT32_C(9)
#define JTAG_PAUSE_DR			EAPI_UINT32_C(10)
#define JTAG_PAUSE_IR			EAPI_UINT32_C(11)
#define JTAG_UPDATE_DR			EAPI_UINT32_C(12)
#define JTAG_UPDATE_IR			EAPI_UINT32_C(13)
#define JTAG_CAPTURE_IR			EAPI_UINT32_C(14)
#define JTAG_CAPTURE_DR			EAPI_UINT32_C(15)

#define LOW_TO_HIGH				EAPI_UINT32_C(0)
#define HIGH_TO_LOW				EAPI_UINT32_C(1)

EApiStatus_t
EAPI_CALLTYPE
EApiJtagInitialization(
	__IN uint8_t trigger_type
);

EApiStatus_t
EAPI_CALLTYPE
EApiJtagChangeState(
	__IN uint32_t target_state,
	__IN uint32_t cycles
);
